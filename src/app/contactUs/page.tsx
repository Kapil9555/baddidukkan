        ...
        <Grid item xs={11} sm={9} md={6} lg={6} sx={{}}>
            <Box>
                <Box sx={{p:"2px 10px",borderRadius:"10px",display:"flex",alignItems:"center",border:"2px solid #bdbdbd"}}>
                    ...
                    <Box>
                        <InputBase placeholder='Name' sx={{color: '#C8C8C8',fontSize:"16px",pl:"5px"}}/>
                    </Box>
                </Box>
                ...
                <Box sx={{mt:"20px",p:"2px 10px",borderRadius:"10px",display:"flex",alignItems:"center",border:"2px solid #bdbdbd"}}>
                    ...
                    <Box>
                        <InputBase placeholder='Contact Number' sx={{color: '#C8C8C8',fontSize:"16px",pl:"5px"}}/>
                    </Box>
                </Box>
                ...
                <Box sx={{mt:"20px",p:"2px 10px",borderRadius:"10px",display:"flex",alignItems:"center",border:"2px solid #bdbdbd"}}>
                    ...
                    <Box>
                        <InputBase placeholder='Message' sx={{color: '#C8C8C8',fontSize:"16px",pl:"5px"}}/>
                    </Box>
                </Box>
                ...
                <Box sx={{mt:"20px",p:"2px 10px",borderRadius:"10px",display:"flex",alignItems:"center",border:"2px solid #bdbdbd"}}>
                    ...
                    <Box>
                        <InputBase placeholder='Email' sx={{color: '#C8C8C8',fontSize:"16px",pl:"5px"}}/>
                    </Box>
                </Box>
