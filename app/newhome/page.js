...
const HomePage = () => {
  ...
  return (
    ...
    <Container maxWidth={'xl'} disableGutters>
        <Grid container justifyContent={'center'} sx={{p:"0px 10px",bgcolor:"black"}}>
            <Grid item lg={6} md={6} sm={10} xs={12} sx={{mb:"15px",bgcolor:"#8bc34a",p:"0px 15px 15px 0px"}}>
                <Grid container sx={{mt:"40px"}}>
                    <Grid item xs={12} sx={{}}>
                        <Box sx={{display:"flex",justifyContent:"space-between",width:"100%"}}>
                            <Typography variant='h3' sx={{fontWeight:600,fontFamily:"sans-serif"}}>
                                <span style={{color:"black"}}>Badi</span><span style={{color:"white"}}>Dukkan</span>
                            </Typography>
                            <Box>
                            <IconButton sx={{bgcolor:"black","&:hover":{bgcolor:"black"},height:"fit-content"}}>
                                <PersonOutlineIcon sx={{color:"#8bc34a"}}/>
                            </IconButton>
                            </Box>
                        </Box>
                    </Grid>
